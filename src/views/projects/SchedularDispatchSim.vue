<template>
  ...
  <div class="central-box">
    ...
    <PageTitle :Title="info.diagramTitle"/>
    ...
    <PageTitle :Title="info.assumptionsTitle"/>

    <Paragraph :item="info.assumptions" />

    <PageTitle :Title="info.modeledAlgorithmsTitle"/>

    <ListBuilder :listObject="info.modeledAlgorithms" />

    <hr class="line-break" />

    <PageTitle :Title="info.algorithmsTitle"/>
    <br/>
    ...
    <div class="page-sub-title">
      Average Turnaround Time<span>.</span>
    </div>
    <img
      style="filter: brightness(85%)"
  ...
  data() {
    return {
      ...
      info: {
        ...
        diagramTitle: {
          text: "Process Schedular Diagram",
          span: ".",
        },
        assumptionsTitle: {
        ...
        modeledAlgorithmsTitle: {
          text: "Modeled Algorithms",
          span: ".",
        },
        algorithmsTitle: {
          text: "Data Gathered from Simulation",
          span: ".",
        },
      },
    };
